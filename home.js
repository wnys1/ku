...
$(function(){
    ...
    $("body").html('<iframe style="width:100%; height:560px;position:absolute;margin-left:0px;margin-top:0px;top:14%;left:0%;" id="mainFrame" src="'+iframe_url+'" frameborder="0" scrolling="no"></iframe>').show();
